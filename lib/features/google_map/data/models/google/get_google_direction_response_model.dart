class GetGoogleDirectionResponseModel {
  List<GeocodedWaypoints>? geocodedWaypoints;
  List<Routes>? routes;
  String? status;

  GetGoogleDirectionResponseModel(
      {this.geocodedWaypoints, this.routes, this.status});

  GetGoogleDirectionResponseModel.fromJson(Map<String, dynamic> json) {
